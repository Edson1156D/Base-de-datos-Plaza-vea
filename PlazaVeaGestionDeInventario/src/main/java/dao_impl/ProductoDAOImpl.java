...
public class ProductoDAOImpl implements ProductoDAO {
    ...
    public boolean registrarProducto(Producto p) {
        ...
        String sql = "INSERT INTO Producto (nombre, descripcion, idTipo, stock, precio, id_proveedor, fechaCaducidad) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean actualizarProducto(Producto p) {
        ...
        String sql = "UPDATE Producto SET nombre=?, descripcion=?, idTipo=?, stock=?, precio=?, id_proveedor=?, fechaCaducidad=? "
                + "WHERE idProducto=?";
    ...
    private Producto mapearProducto(ResultSet rs) throws SQLException {
        ...
        p.setIdProveedor(rs.getInt("id_proveedor"));  // <-- CORRECTO
